...
logger.info(f"{formatted_datetime} \t\t\tROOT COMPLEX : Compiling pcie_rc_tx_monitor.py file")
...
logger.info(f"{formatted_datetime} \t\t\tROOT COMPLEX : Generating gen_logs/mon_logs/rc_tx_good_monitor_log.txt log")
rc_monitor_f.close()
logger.info(f"{formatted_datetime} \t\t\tROOT COMPLEX : Generating gen_logs/mon_logs/rc_tx_mixed_monitor_log.txt log")
