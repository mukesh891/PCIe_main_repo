...
logger.info(f"{formatted_datetime} \t\t\tROOT COMPLEX : Compiling pcie_rc_generated_logs.py file")
class pcie_rc_generated_logs:
    ...
    def bin_file_handle(self):
        ...
        for i in range(g_pkt_queue.qsize()):
            ...
            f.write(str(q))
            f.write("\n")
        logger.info(f"{formatted_datetime} \t\tROOT COMPLEX : Generating gen_logs/rc_tx_good_bin_file.txt log")
        f.close()
    def hex_file_handle(self):
        ...
        for line in bin_f:
            ...
            hex_f.write("\n")
        hex_f.close()
        logger.info(f"{formatted_datetime} \t\tROOT COMPLEX : Generating gen_logs/rc_tx_good_hex_file.txt log")
        bin_f.close()
    ...
    def mem_rd_file_handle(self):
        ...
        bin_f.close()
        mem_bin_f.close()
        logger.info(f"{formatted_datetime} \t\tROOT COMPLEX : Generating gen_logs/rc_mem_bin_file.txt log")
    ...
    def gen_log(self):
        ...
        gen_f.close()
        logger.info(f"{formatted_datetime} \t\tROOT COMPLEX : Generating gen_logs/rc_tx_generator_out.txt log")
        bin_f.close()
