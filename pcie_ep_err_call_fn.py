...
class pcie_ep_err_call:
    ...
    def ep_err_call_fn(self):
        ...
        for line in good_compl:
                ...
                if(self.err_id < compl_qsize):                  
                    ...
                    if self.err_id in ep_err_arr:          
                        ...
                        if(j==1):
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==3):
                            TC =ep_err_inj_hdl.pcie_TC_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==4):
                            Attr1 =ep_err_inj_hdl.pcie_attr1_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==5):
                            TH =ep_err_inj_hdl.pcie_TH_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==6):
                            TD =ep_err_inj_hdl.pcie_TD_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==7):
                            EP =ep_err_inj_hdl.pcie_EP_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==8):
                            attr0 =ep_err_inj_hdl.pcie_attr0_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==9):
                            AT =ep_err_inj_hdl.pcie_AT_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        '''if(j==10):
                            length =ep_err_inj_hdl.pcie_length_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)'''
                        if(j==11):
                            Completer_ID =ep_err_inj_hdl.pcie_Completer_ID_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==11):
                            Compl_Status =ep_err_inj_hdl.pcie_Compl_Status_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        if(j==12):
                            BCM =ep_err_inj_hdl.pcie_BCM_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        '''if(j==13):
                            Byte_Count =ep_err_inj_hdl.pcie_Byte_Count_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)'''
                        if(j==14):
                            Requester_ID =ep_err_inj_hdl.pcie_Requester_ID_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)
                        '''if(j==15):
                            Tag =ep_err_inj_hdl.pcie_Tag_err_eij(self.err_id)
                            ...
                            compl_pkt_queue.put(TLP_error)'''
                        if(j==16):
                            Lower_Address =ep_err_inj_hdl.pcie_Lower_Address_err_eij(self.err_id)
            ...
            pcie_final_ep_tx_table_file.pcie_final_ep_tx_table_fn(self.err_id-1, TLP)
        good_compl.close()
